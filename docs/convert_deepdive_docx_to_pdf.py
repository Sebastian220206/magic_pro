...
DOCX = ROOT / "docs" / "Magic_Pro_DeepDive_Report.docx"
PDF = ROOT / "docs" / "Magic_Pro_DeepDive_Report.pdf"
...
def header_footer(canvas, doc):
    ...
    canvas.drawString(doc.leftMargin, height - 0.35 * inch, "Magic Pro DAW — Project Deep Dive Report")
...
def build_pdf() -> Path:
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=top,
        bottomMargin=bottom,
        title="Magic Pro DAW Deep Dive Report",
        author="Codex",
        subject="Browser DAW project deep dive",
    )
