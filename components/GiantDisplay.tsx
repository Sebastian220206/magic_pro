...
export function GiantDisplay({ type, onClose }: GiantDisplayProps) {
    ...
    return (
        <div className="fixed top-20 left-20 z-[2500] bg-[#1a1a1a] rounded-lg border border-black shadow-[0_20px_60px_rgba(0,0,0,0.8)] flex flex-col overflow-hidden animate-in fade-in slide-in-from-top-4 duration-300 min-w-[320px]">
            {/* Title Bar */}
            <div className="bg-[#2c2c2c] border-b border-black px-3 py-1 flex items-center justify-between cursor-move">
                ...
                <X className="w-3 h-3 text-gray-600 hover:text-white cursor-pointer" onClick={onClose} />
            </div>
            ...
            <div className="p-8 bg-black flex items-center justify-center font-mono select-none">
                {type === 'giantBeats' ? (
                    <div className="flex gap-4 items-baseline">
                        <span className="text-gray-900 text-[80px] absolute">0000 0 0 000</span>
                    ...
                    <div className="flex gap-2 items-baseline">
                        <span className="text-gray-900 text-[80px] absolute">00:00:00.000</span>
                        <div className="flex gap-2 items-baseline relative text-[#87CEEB]">
            ...
            {/* Bottom Trim */}
            <div className="h-2 bg-[#2c2c2c] border-t border-black"></div>
        </div>
    )
}
