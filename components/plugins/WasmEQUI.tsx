...
export function WasmEQUI({ params, onParamChange }: PluginUIContract) {
  ...
  return (
    <div className="bg-studio-raised p-4 rounded border border-studio-line shadow-xl select-none w-80 text-white">
      <div className="flex justify-between items-center mb-4 border-b border-studio-line pb-2">
        <h3 className="text-xs font-black tracking-widest text-studio-text-mid">MAGIC EQ</h3>
      ...
      <div className="space-y-4">
        <div className="flex flex-col">
          <div className="flex justify-between text-xs mb-1">
            <span className="text-studio-text-mid">Gain</span>
          ...
          <input type="range" min="-24" max="24" step="0.1" value={gain}
            ...
            className="w-full accent-amber-500 bg-studio-sunken appearance-none h-2 rounded cursor-pointer" />
        </div>

        <div className="flex flex-col">
          <div className="flex justify-between text-xs mb-1">
            <span className="text-studio-text-mid">Frequency</span>
        ...
        <div className="flex flex-col">
          <div className="flex justify-between text-xs mb-1">
            <span className="text-studio-text-mid">Q (Resonance)</span>
