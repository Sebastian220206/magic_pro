...
export function MIDIActivity({ customStyle = false }) {
        ...
        return (
            ...
            >
                <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[7px] text-gray-500 font-mono truncate max-w-[80px] uppercase">
    ...
    return (
        <div className="flex items-center gap-1 opacity-60">
            <div className={`w-1.5 h-1.5 rounded-full ${blinkIn ? 'bg-green-400 shadow-[0_0_8px_rgba(74,222,128,0.8)]' : 'bg-gray-800'}`}></div>
            <div className={`w-1.5 h-1.5 rounded-full ${blinkOut ? 'bg-yellow-400 shadow-[0_0_8px_rgba(250,204,21,0.8)]' : 'bg-gray-800'}`}></div>
        </div>
    )
}
